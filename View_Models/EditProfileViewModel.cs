...
namespace App_CCP.View_Models
{
    public class EditProfileViewModel
    {
        ...
        [BindNever]
        public bool IsCardRevoked { get; set; }
        ...
        [Required(ErrorMessage = "Selectează o opțiune!")]
        [Display(Name = "Ocupație")]
        public Occupation Occupation { get; set; }= Occupation.Copil;
       
        [StringLength(500, ErrorMessage = "Mențiunile nu pot depăși 500 caractere.")]
        [Display(Name = "Mențiuni")]
        ...
        public string? ProfileCardUrl { get; set; }
